...
const Footer = () => {
  return (
    ...
    <div className='py-16 px-4'>
        ...
        <a href='/' className="footer-description font-normal md:text-[45px] items-center flex gap-2">Drop a Hello <img className=' w-[44px] self-center h-[44px]' src='/images/Left Arrow.png' alt='Left Arrow'/></a> 
    </div>
    <div className='flex flex-col items-center ml-5'>
      <img className='md:mb-[39px]' src="/images/Footer Logo.png" alt="Avex Logo" />
      <p className='text-lg text-base-100'><a href="/">Downloads</a> | <a href="/">Blogs</a> | <a href="/">Terms</a> | <a href="/">Privacy</a></p>
          ...
          <img src="/images/phone.png" alt="Phone" className="mb-0 ml-8 instagram-link" />s
    ...
    <form action="#" className='mr-[86px]'>
      ...
      <div className='flex gap-2  '>
        <input type="email" placeholder="abc@example.com" className="input rounded-[23px] bg-[#323232] w-full md:w-[218px] inline" />
